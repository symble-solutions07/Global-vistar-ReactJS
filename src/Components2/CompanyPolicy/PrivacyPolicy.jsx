...
function PrivacyPolicy() {
  return (
    <div style={{margin: "2rem"}}>
        ...
        <h3>Last updated on 20-02-2024 14:56:55</h3>
        <p>This privacy policy (“Policy”) relates to the manner SYMBLE SOLUTIONS PRIVATE LIMITED
        ...
        SYMBLE SOLUTIONS PRIVATE LIMITED may change this Policy periodically and we urge you to
        check this page for the latest version of the Policy in order to keep yourself updated.</p>
        ...
        <p>Right to Review - You can review the data provided by you and can request us to correct or amend such
        ...
        info@globalvistar.comIn the event you choose to not provide or later withdraw your consent, we may not
