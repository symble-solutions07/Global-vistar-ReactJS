      ...
      {dashOpen && 
        ...
        <div className="dashboard-body">
          ...
          <div className="dashboard-title-flex">
            {dashOpen ? <img className='mobile-arrow' onClick={handleDashOpen} src={Cross} alt="" />: <img className='mobile-arrow' onClick={handleDashOpen} src={RightArrow} alt="" />}
          ...
          <div className="dashboard-footer">
            <p className="dashboard-footer-p">© 2023 Global Vistar - A Symble Solutions Pvt Ltd Company. All Rights Reserved</p>
          </div>
